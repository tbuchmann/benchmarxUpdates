...
public class ScalabilityIncrTestsFwd extends ScalabilityTests {
		...
		try {
			assertTimeoutPreemptively(Duration.ofSeconds(TIMEOUT), () -> {
				recordResult(tool, nrOfDigits,
						...
						srcEdit(() -> helperAst.extendBestDigitsChain(nrOfDigits))));
			});
		} catch (Throwable t) {
	...
	@ParameterizedTest @MethodSource("tools")
	public void testCreate0000300Digits(BXTool<ast.Model, dag.Model, Decisions> tool) { this.tool = tool; initialise(); extendOneMoreDigit(300); }
