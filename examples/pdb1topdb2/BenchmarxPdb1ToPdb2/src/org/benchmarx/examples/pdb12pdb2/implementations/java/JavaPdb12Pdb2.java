package org.benchmarx.examples.pdb12pdb2.implementations.java;
...
import de.university.hof.transformations.java.JavaPdb12Pdb2Transformation;
import pdb1.Database;
import pdb1.Pdb1Factory;

public class JavaPdb12Pdb2 extends BXToolForEMF<pdb1.Database, pdb2.Database, Decisions> {
	...
	public void initiateSynchronisationDialogue() {
		...
		JavaPdb12Pdb2Transformation.transformForward(source, target);
	}
	...
	public void performAndPropagateTargetEdit(Supplier<IEdit<pdb2.Database>> targetEdit) {
		targetEdit.get();
		JavaPdb12Pdb2Transformation.transformBackward(source, target);
	}
