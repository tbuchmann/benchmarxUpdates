package org.benchmarx.examples.pdb12pdb2.implementations.bxlang;
...
import dev.bxlang.generated.pdb1topdb2.PDB1toPDB2Transformation;
import pdb1.Database;
import pdb1.Pdb1Factory;

public class BXLangPdb12Pdb2 extends BXToolForEMF<pdb1.Database, pdb2.Database, Decisions> {
	
	private ResourceSet set = new ResourceSetImpl();
	private Resource source;
	private Resource target;
	private Resource corr;
	private PDB1toPDB2Transformation p2pt;
	...
	public void initiateSynchronisationDialogue() {
		...
		p2pt = new PDB1toPDB2Transformation();
		target = p2pt.transformForward(source, target);
...
//		else options = new Pdb12Pdb2Transformation.Options("last");
		...
		source = p2pt.transformBackward(target, source);
	}
