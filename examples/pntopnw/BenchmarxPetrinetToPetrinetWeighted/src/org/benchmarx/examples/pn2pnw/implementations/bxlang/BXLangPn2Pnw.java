package org.benchmarx.examples.pn2pnw.implementations.bxlang;
...
import dev.bxlang.generated.petrinet2weighted.PetriNet2WeightedTransformation;
import pn.Net;

public class BXLangPn2Pnw extends BXToolForEMF<pn.Net, pnw.Net, Decisions> {

	private ResourceSet set = new ResourceSetImpl();
	private Resource source;
	private Resource target;
	private Resource corr;
	private PetriNet2WeightedTransformation pn2pnw;
	...
	public void initiateSynchronisationDialogue() {
		...
		pn2pnw = new PetriNet2WeightedTransformation();
				
		// perform batch to establish consistent starting state
		pn2pnw.transformForward(source, target);
	}
	...
	public void performAndPropagateTargetEdit(Supplier<IEdit<pnw.Net>> edit) {
		edit.get();
		pn2pnw.transformBackward(target, source);
	}
